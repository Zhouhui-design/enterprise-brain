<template>
  ...
  <el-dialog
    ...
    :title="isEdit ? '编辑激光下料工序计划' : '新增激光下料工序计划'"
    width="80%"
  ...
  >
    <el-form ref="formRef" :model="formData" :rules="formRules" label-width="140px">
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="激光下料工序计划编号" prop="planNo">
...
const loadData = async () => {
  ...
  try {
    const params = {
      ...
      processName: '激光下料',  // ✅ 强制过滤：只显示激光下料工序
...
const handleDelete = (row) => {
  ElMessageBox.confirm(
    `确定要删除激光下料工序计划编号为 ${row.planNo} 的记录吗？`,
    '删除确认',
    {
