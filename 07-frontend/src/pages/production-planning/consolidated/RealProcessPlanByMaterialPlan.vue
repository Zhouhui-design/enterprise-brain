<template>
  <StandardTablePage
    page-title="打包工序计划 - 按备料计划编号合并"
    settings-key="realProcessPlanByMaterialPlanV1"
...
const consolidatedColumns = ref([
  ...
  { prop: 'salesOrderNo', label: '备料计划编号编号', width: 160, sortable: true, filterable: true, visible: true },
