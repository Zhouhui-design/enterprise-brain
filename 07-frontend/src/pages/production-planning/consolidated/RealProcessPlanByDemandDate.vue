<template>
  <StandardTablePage
    page-title="打包工序计划 - 按需求日期合并"
    settings-key="realProcessPlanByDemandDateV1"
...
const consolidatedColumns = ref([
  ...
  { prop: 'salesOrderNo', label: '需求日期编号', width: 160, sortable: true, filterable: true, visible: true },
