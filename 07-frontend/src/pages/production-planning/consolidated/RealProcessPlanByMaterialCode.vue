<template>
  <StandardTablePage
    page-title="打包工序计划 - 按计划物料编号合并"
    settings-key="realProcessPlanByMaterialCodeV1"
...
const consolidatedColumns = ref([
  ...
  { prop: 'salesOrderNo', label: '计划物料编号编号', width: 160, sortable: true, filterable: true, visible: true },
