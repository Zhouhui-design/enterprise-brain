<template>
  ...
  <el-dialog
    ...
    :title="isEdit ? '编辑打孔工序计划' : '新增打孔工序计划'"
    width="80%"
  ...
  >
    <el-form ref="formRef" :model="formData" :rules="formRules" label-width="140px">
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="打孔工序计划编号" prop="planNo">
...
const handleDelete = (row) => {
  ElMessageBox.confirm(
    `确定要删除打孔工序计划编号为 ${row.planNo} 的记录吗？`,
    '删除确认',
    {
