          ...
          <el-table :data="businessVariables" border stripe max-height="400">
            <el-table-column label="变量名称" width="180">
              <template #default="{ row }">
                <el-input v-model="row.name" placeholder="例如：提前入库期" size="small" />
              </template>
            </el-table-column>
            <el-table-column label="变量值" width="150">
              <template #default="{ row }">
                <el-input v-model="row.value" placeholder="例如：7" size="small" />
              </template>
            </el-table-column>
        ...
        <div class="tab-content">
          ...
          <el-table :data="workflowConfigs" border stripe max-height="400">
            <el-table-column label="触发按钮" width="150">
              <template #default="{ row }">
                <el-input v-model="row.buttonName" placeholder="例如：推送" size="small" />
              </template>
            </el-table-column>
        ...
        <div class="tab-content">
          ...
          <el-table :data="codeRules" border stripe max-height="400">
            <el-table-column label="目标字段" width="150">
              <template #default="{ row }">
                <el-input v-model="row.fieldName" placeholder="例如：备料计划编号" size="small" />
              </template>
            </el-table-column>
            <el-table-column label="前缀" width="100">
              <template #default="{ row }">
                <el-input v-model="row.prefix" placeholder="MPP" size="small" @input="updateExample(row)" />
              </template>
            </el-table-column>
