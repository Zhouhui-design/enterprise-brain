...
async function testRequiredWorkHours() {
  ...
  try {
    ...
    console.log(
      `结果验证: ${createdPlan1.requiredWorkHours == testPlan1.expectedRequiredHours ? '✅ 通过' : '❌ 失败'}`,
    );
    ...
    console.log(
      `结果验证: ${createdPlan2.requiredWorkHours == testPlan2.expectedRequiredHours ? '✅ 通过' : '❌ 失败'}`,
    );
    ...
    console.log(
      `结果验证: ${createdPlan3.requiredWorkHours == testPlan3.expectedRequiredHours ? '✅ 通过' : '❌ 失败'}`,
    );
    ...
    console.log(
      `结果验证: ${createdPlan5.requiredWorkHours == testPlan5.expectedRequiredHours ? '✅ 通过' : '❌ 失败'}`,
    );
