...
-- 3. 备料计划相关表修复
ALTER TABLE material_preparation_plans 
ADD COLUMN IF NOT EXISTS product_image VARCHAR(500) COMMENT '产品图片' 
AFTER customer_name;

ALTER TABLE material_preparation_plans 
ADD COLUMN IF NOT EXISTS submitter VARCHAR(100) COMMENT '提交人' 
AFTER product_image;
...
SHOW COLUMNS FROM material_preparation_plans LIKE 'product_image';
SHOW COLUMNS FROM material_preparation_plans LIKE 'submitter';